...
PYTHONPATH=src python3 -m content_guard.publish_check \
  --pr-body /home/user/scratch/watchtower-pr-dogfood/pr-body.md \
  --out-dir /home/user/scratch/watchtower-pr-dogfood/publish-check \
  --json
```
...
- `publish_body_file` pointed to `/home/user/scratch/watchtower-pr-dogfood/publish-check/pr-body.public.md`.
