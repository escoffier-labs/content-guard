...
### Deprecated
- Final release. Content Guard is merged into brigade-cli as the `brigade guard` command group. Install `brigade-cli` for the maintained scanner. This repository is archived.
